const dataHTML = (processData, whithoutAction) => {
  const { filingNumber, lastUpdateDate } = processData;
                ...
                <tr style="border-collapse: collapse">
                  ...
                  >
                    <p
                      ...
                      "
                    >
                    Días sin actuaciones: ${Number(whithoutAction).toFixed()}
                    </p>
                  </td>
                </tr>
              </table>
                ...
                <tr style="border-collapse: collapse">
                  ...
                  >
                    <p
                      ...
                      "
                    >
                     Numero de Radicado: ${filingNumber} 
                    </p>
                    ...
                    <p
                      ...
                      "
                    >
                     Ultima actualización: ${new Date(lastUpdateDate)
                       .toISOString()
                       .slice(0, 10)} 
                    </p>
                  </td>
